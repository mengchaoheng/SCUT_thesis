%======== 切换封面格式 ========
%----------硕士封面-----------
%\documentclass[unicode,master,pdfcover]{scutthesis}	% 论文正式封面，使用pdf文件封面的 硕士模板
\documentclass[unicode,master]{scutthesis}	%  草稿封面，不使用pdf文件封面的 硕士模板
%----------博士封面-----------
% \documentclass[unicode,pdfcover]{scutthesis}	% 论文正式封面，使用pdf文件封面的博士模板
% \documentclass[unicode]{scutthesis}	%  草稿封面，不使用pdf文件封面的博士模板
%======== 切换封面格式 END ========
...
%-------- 会议ref样式：xxxxxx[C]. 某某会议，xxxxx --------
\usepackage[backend=biber,style=gb7714-2015,gbalign=gb7714-2015,gbpub=false,gbnamefmt = lowercase ,gbpunctin=false]{biblatex} % 添加gbpuctin=false用于去除//
\DefineBibliographyStrings{english}{in={}} % 去掉会议前的 "in:"
% 会议参考文献格式讨论可参考：https://github.com/mengchaoheng/SCUT_thesis/issues/38
...
%
%=========== PDF 引用、超链接、URL颜色设置 ===========
	% linkcolor=black, anchorcolor=black, citecolor=black, filecolor=black, menucolor=black, urlcolor=black, % 黑白，提交版
	linkcolor=blue, anchorcolor=black, citecolor=red, filecolor=magenta, menucolor=red, urlcolor=magenta, % 彩色
%=========== PDF 引用、超链接、URL颜色设置 END ===========
	pdfstartview=FitH
}
